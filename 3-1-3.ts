...
interface BigObject {
    [key: string]: { cvalue: string | number | BigObject } | undefined;
}
...
const test: BigObject = { hello: {cvalue: 1}, world: { cvalue: { yay: { cvalue: "2" } } } };
console.log(summ(test));

// - 1 - стр 47 - 2021 string замість 2022 number
// - 2 - 51 - String -> string
// - 3 - 53 - "c" -> c
// - 4 - 56 - lenght -> length
// - 5 - 62 - summ -> sum
